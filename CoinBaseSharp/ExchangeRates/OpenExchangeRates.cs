...
namespace CoinBaseSharp.ExchangeRates
{
    ...
    public class OpenExchangeRates
    {
        ...
        public decimal CUC { get; set; } // int 
        ...
        public decimal PAB { get; set; } // int 
        ...
        public decimal USD { get; set; } // int 
    ...
    public class OpenExchangeRatesData : OpenExchangeRatesResponse
    {
        ...
        public System.DateTime SnapshotTime
        {
            get
            {
                if (m_SnapshotTime.HasValue)
                    return m_SnapshotTime.Value;
        ...
        public System.Collections.Generic.Dictionary<string, decimal> RatesList
        {
            get
            {
                ...
                this.m_rates = new System.Collections.Generic.Dictionary<string, decimal>(System.StringComparer.InvariantCultureIgnoreCase);

                // If the response is an error ==> no rates
                if (this.rates == null)
                    return m_rates;

                System.Reflection.PropertyInfo[] propertyList = typeof(OpenExchangeRates).GetProperties();

                for (int i = 0; i < propertyList.Length; ++i)
                {
                    object objVal = propertyList[i].GetValue(this.rates);
